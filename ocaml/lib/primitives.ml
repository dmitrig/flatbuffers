...
let[@inline] get_bool (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Bytes.get b i == '\001'
  | String -> String.get b i == '\001'
  | Bigstring -> Bigstringaf.get b i == '\001'
;;

let[@inline] get_byte (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Bytes.get_int8 b i
  | String -> String.get_int8 b i
  | Bigstring -> Util.as_signed 8 (Char.code (Bigstringaf.get b i))
;;

let[@inline] get_ubyte (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Bytes.get b i
  | String -> String.get b i
  | Bigstring -> Bigstringaf.get b i
;;

let[@inline] get_short (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Bytes.get_int16_le b i
  | String -> String.get_int16_le b i
  | Bigstring -> Util.as_signed 16 (Bigstringaf.get_int16_le b i)
;;

let[@inline] get_ushort (type b) (prim : b t) (b : b) i =
  match prim with
...
let[@inline] get_int (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Bytes.get_int32_le b i
  | String -> String.get_int32_le b i
  | Bigstring -> Bigstringaf.get_int32_le b i
...
let[@inline] get_uint (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Bytes.get_int32_le b i
  | String -> String.get_int32_le b i
  | Bigstring -> Bigstringaf.get_int32_le b i
...
let[@inline] get_long (type b) (prim : b t) (b : b) i =
  match prim with
...
let[@inline] get_ulong (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Bytes.get_int64_le b i
  | String -> String.get_int64_le b i
  | Bigstring -> Bigstringaf.get_int64_le b i
...
let[@inline] get_float (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Int32.float_of_bits (Bytes.get_int32_le b i)
  | String -> Int32.float_of_bits (String.get_int32_le b i)
  | Bigstring -> Int32.float_of_bits (Bigstringaf.get_int32_le b i)
;;

let[@inline] get_double (type b) (prim : b t) (b : b) i =
  match prim with
  | Bytes -> Int64.float_of_bits (Bytes.get_int64_le b i)
  | String -> Int64.float_of_bits (String.get_int64_le b i)
  | Bigstring -> Int64.float_of_bits (Bigstringaf.get_int64_le b i)
;;
